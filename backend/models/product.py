...
class ProductDB(Base):
    ...
    serving_size = Column(Float, nullable=False, default=100.0)  # in grams (backend storage)
...
class ProductBase(BaseModel):
    ...
    serving_amount: float = Field(default=100.0, gt=0, description="Display amount for serving")
